...
<head>
	...
	<style type="text/css">
		body{margin: 0; padding: 0; background: #f4f4f4 url('{{ CustomUrl::asset('email_images/bg.jpg') }}') repeat-x; font-family: arial;}
...
<body>
	<div style="background:url('{{ CustomUrl::asset('email_images/bg.jpg') }}'); background-repeat:repeat-x;">
	<header>
		<a href="https://www.nextaxe.com" class="logo" alt="nextaxe logo"><div  class="header"><img src="{{CustomUrl::asset('backoffice/assets/img/logo.png')}}"></div>
        </a>
	</header>
