  ...
  <div class="container">
            <div class="row" style=" margin-top: -21px; margin-bottom: 17px;">
              ...
              <div class="col-6 text-right">
                <a href="{{route('schools.create')}}" class="btn btn-primary btn-rounded btn-fw" >Add</a> 
              </div>
            </div>
...
@foreach($schools as $school)
            <tr>
                ...
                <td>
                     <span   class="btn-rounded btn-icon" data-toggle="dropdown" aria-expanded="false" id="UserDropdown   "> <i class="fas fa-angle-down"></i></span>
                  <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                      ...
                      <a class="dropdown-item text-danger" href="{{route('schools.destroy',$school->id)}}"> Delete</a>
                  </div>
                </td>
