...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <h1 class="logoname"><a href="index.html">ImSchool</a></h1>
    </div>
    <nav id="mainav" class="fl_right"> 
      <ul class="clear">
        ...
        <li><a href="{{route('login')}}" id="login" style="background-color: crimson; padding: 10px; margin: -4px;
}">Login HERE</a></li>
      </ul>
      <!-- ################################################################################################ -->
    </nav>
...
<script src="{{asset('web/js/jquery.backtotop.js')}}"></script>
